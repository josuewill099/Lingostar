// Astro API route — handles POST /api/contact. Runs inside the Node server
// on every request, so it needs two environment variables at runtime
// (set them in Coolify's Environment Variables tab for this app, not in
// the repo):
